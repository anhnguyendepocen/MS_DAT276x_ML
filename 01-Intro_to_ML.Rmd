...
Turn free text into sturctured information:
...
* If you want to answer a yes/no question, this is classificaiton.
    + For manholes, will the manhole explode nect year? Y/N.
...
* Don't bother doing the project in the first place if no one plans to deploy it. ( Unless it's fun.)
